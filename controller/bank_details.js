        ...
        .then((user) => {
          if (user.verified) {
                    ...
                    if (details == null) {
                      ...
                      res
                        ...
                        .json({
                          success: false,
                          message:
                            "account already exist for you try applying for change of account",
                        });
                    }
                  });
                } else {
            ...
            res
              ...
              .json({
                success: false,
                message: "verify account before creating card details",
              });
          }
        })
        .catch((err) => {
  ...
  getBank(req, res) {
    try {
      auth_user
        ...
        .then((user) => {
          bank_approved
            .findOne({ user: user._id }, (err, bank_details) => {
              if (err)
                res
                  .status(203)
                  .json({
                  ...
                  bank_pending.findOne({ user: user._id }, (err, details) => {
                    if (details == null) {
                          ...
                          if (err)
                            res
                              ...
                              .json({
                                success: false,
                                message:
                                  "error sending account for verification",
                              });
                          res
                            .status(200)
                            .json({
                      ...
                      res
                        ...
                        .json({
                          success: false,
                          message: "already applied for change of bank",
                        });
                    }
                  });
                } else {
